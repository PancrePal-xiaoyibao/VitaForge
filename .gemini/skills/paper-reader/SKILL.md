...
| 文件 | 路径 | 用途 | 何时加载 |
|------|------|------|----------|
| 论文分析方法论 | `references/paper-analysis-methodology.md` | CoT 分步精读、批判性评估清单与局限分析方法 | 需要方法论支撑或跨学科精读时 |
| PDF 预处理脚本 | `scripts/pdf-processor.py` | 把 PDF 文本层预处理为可分析的段落结构 | 原始论文为 PDF 时 |
...
| 关系 | Skill | 场景 |
|------|-------|------|
| 可调用 | pubmed-linker | 需要查找引用的 PubMed 链接 |
| 可调用 | deep-research | 单篇精读后需扩展到系统调研 |
